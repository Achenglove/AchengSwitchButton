package com.ccr.switchbuttonlibrary;
...
public class ASwitchButton extends View implements Checkable {
    ...
    public ASwitchButton(Context context) {
        super(context);
        init(context, null);
    }

    public ASwitchButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public ASwitchButton(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public ASwitchButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public interface OnCheckedChangeListener{
        void onCheckedChanged(ASwitchButton view, boolean isChecked);
    }
